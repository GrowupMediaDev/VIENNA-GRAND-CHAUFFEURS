...
export const VEHICLES_DATA: Vehicle[] = [
...

  {
    ...
    img: { hero: '/images/fahrzeuge/vip-minibus-hero.jpg', ueberblick: '/images/fahrzeuge/ueberblick-vip-minibus.jpg', vorteil: '/images/fahrzeuge/vorteil-vip-minibus.jpg', kabineBg: KAB_BG, gallery: ['/images/fahrzeuge/vip-minibus-gal-1.jpg', '/images/fahrzeuge/vip-minibus-gal-2.jpg', '/images/fahrzeuge/vip-minibus-gal-3.jpg', '/images/fahrzeuge/vip-minibus-gal-4.jpg', '/images/fahrzeuge/vip-minibus-gal-5.jpg'], card: '/images/fahrzeuge/card-vip-minibus.jpg' },
    ...
    vprice: {
      ...
      sub: 'Keine versteckten Kosten — Wartezeit, Maut und Parkgebühren sind immer inklusive. Bei Buchung garantiert.',
      cards: [
        { title: 'Flughafentransfer', sub: 'Festpreis pro Strecke', price: '€480', unit: '/ Strecke', desc: 'Inkl. 60 Min. Wartezeit und Gepäckservice — die ganze Gruppe im VIP-Lounge-Interieur.', cta: 'Transfer buchen', featured: true },
        { title: 'Stundensatz', sub: 'Mindestens 3 Stunden', price: '€360', unit: '/ Stunde', desc: 'Chauffeur zur freien Verfügung — ideal für Roadshows, Firmenevents und VIP-Programme.', cta: 'Stunden buchen' },
        { title: 'Tagessatz', sub: '8 Stunden inklusive', price: '€2.880', unit: '/ Tag', desc: 'Ein Chauffeur für den ganzen Tag — für Delegationen, Touren und exklusive Gruppenanlässe.', cta: 'Tag buchen' },
      ],
    },
    faq: [
      ...INCLUDED_FAQ('VIP Sprinter Minibus'),
      { q: 'Worin unterscheidet sich der VIP Sprinter vom Business Sprinter?', a: 'Der Business Sprinter ist unser geräumiges Gruppenfahrzeug für bis zu 19 Gäste. Der VIP Sprinter Minibus hat dagegen ein handveredeltes Lounge-Interieur mit einzelnen Captain-Sitzen, Ambientelicht und Entertainment für bis zu 12 Gäste — Luxus statt reiner Kapazität.' },
...

  {
    ...
    cardSpecs: 'Bis 19 Gäste · viel Gepäck · Gruppen & Events',
    metaTitle: 'Mercedes-Benz Sprinter — Vienna Grand Chauffeurs',
    metaDescription: 'Der Mercedes-Benz Sprinter: geräumiges Gruppenfahrzeug für bis zu 19 Gäste in Wien und ganz Österreich. Ideal für Events, Delegationen und Transfers.',
    heroSub: 'Premium Chauffeurservice in Wien & Österreich, ganz nach Ihren Wünschen',
    heroStats: [
      { label: 'Passagiere', value: 'Bis 19', accent: 'Bis' },
      { label: 'Gepäck', value: 'Sehr viel' },
      { label: 'Karosserie', value: 'Sprinter' },
    ],
    img: { hero: '/images/fahrzeuge/business-sprinter-gal-1.jpg', ueberblick: '/images/fahrzeuge/ueberblick-business-sprinter.jpg', vorteil: '/images/fahrzeuge/vorteil-business-sprinter.jpg', kabineBg: KAB_BG, gallery: ['/images/fahrzeuge/business-sprinter-gal-1.jpg', '/images/fahrzeuge/business-sprinter-gal-2.jpg', '/images/fahrzeuge/business-sprinter-gal-3.jpg', '/images/fahrzeuge/business-sprinter-gal-4.jpg', '/images/fahrzeuge/business-sprinter-gal-5.jpg'], card: '/images/fahrzeuge/card-business-sprinter.jpg' },
    vover: { titleLead: 'Das große Fahrzeug für', titleAccent: 'Gruppen & Events.', body: 'Der Mercedes-Benz Sprinter bringt große Gruppen komfortabel und gemeinsam ans Ziel. Mit Platz für bis zu 19 Gäste und reichlich Gepäck ist er die ideale Lösung für Events, Delegationen, Betriebsausflüge und größere Transfers.' },
    ...
    vben: {
      ...
      items: ['Platz für bis zu 19 Gäste plus viel Gepäck', 'Ideal für Events, Delegationen und Betriebsausflüge', 'Erfahrene Chauffeure, diskret, pünktlich, mit Flugüberwachung', 'Fixpreise ohne versteckte Kosten'],
      badge: { big: '19', sm: 'Sitzplätze' },
    },
    vprice: {
      title: 'Transparente Festpreise.',
      sub: 'Keine versteckten Kosten — Wartezeit, Maut und Parkgebühren sind immer inklusive. Bei Buchung garantiert.',
    ...
    faq: [
      ...
      { q: 'Wie viele Gäste passen in den Mercedes-Benz Sprinter?', a: 'Je nach Ausführung bietet der Sprinter Platz für bis zu 19 Gäste plus Gepäck — ideal für große Gruppen.' },
...
export const VEHICLES_DATA_EN: Vehicle[] = [
...

  {
    ...
    vprice: {
      ...
      sub: 'No hidden costs — waiting time, tolls and parking are always included. Guaranteed at booking.',
      cards: [
        { title: 'Airport transfer', sub: 'Fixed price per trip', price: '€480', unit: '/ trip', desc: 'Incl. 60 min waiting time and luggage service — the whole group in the VIP lounge interior.', cta: 'Book transfer', featured: true },
        { title: 'Hourly rate', sub: 'Minimum 3 hours', price: '€360', unit: '/ hour', desc: 'Chauffeur at your disposal — ideal for roadshows, corporate events and VIP programmes.', cta: 'Book by the hour' },
        { title: 'Daily rate', sub: '8 hours included', price: '€2,880', unit: '/ day', desc: 'A chauffeur for the whole day — for delegations, tours and exclusive group occasions.', cta: 'Book a day' },
      ],
    },
    faq: [
      ...INCLUDED_FAQ_EN('VIP Sprinter Minibus'),
      { q: 'How does the VIP Sprinter differ from the Business Sprinter?', a: 'The Business Sprinter is our spacious group vehicle for up to 19 guests. The VIP Sprinter Minibus, by contrast, has a hand-finished lounge interior with individual captain seats, ambient lighting and entertainment for up to 12 guests — luxury rather than pure capacity.' },
...

  {
    ...
    group: 'Business Sprinter',
    cardKlass: 'Business · Sprinter',
    cardSpecs: 'Up to 19 guests · lots of luggage · Groups & Events',
    metaTitle: 'Sprinter — Vienna Grand Chauffeurs',
    metaDescription: 'The Mercedes-Benz Sprinter: a spacious group vehicle for up to 19 guests in Vienna and throughout Austria. Ideal for events, delegations and transfers.',
    heroSub: 'Premium chauffeur service in Vienna & Austria, entirely tailored to your wishes',
    heroStats: [
    ...
    img: { hero: '/images/fahrzeuge/business-sprinter-gal-1.jpg', ueberblick: '/images/fahrzeuge/ueberblick-business-sprinter.jpg', vorteil: '/images/fahrzeuge/vorteil-business-sprinter.jpg', kabineBg: KAB_BG, gallery: ['/images/fahrzeuge/business-sprinter-gal-1.jpg', '/images/fahrzeuge/business-sprinter-gal-2.jpg', '/images/fahrzeuge/business-sprinter-gal-3.jpg', '/images/fahrzeuge/business-sprinter-gal-4.jpg', '/images/fahrzeuge/business-sprinter-gal-5.jpg'], card: '/images/fahrzeuge/card-business-sprinter.jpg' },
    vover: { titleLead: 'The large vehicle for', titleAccent: 'Groups & Events.', body: 'The Mercedes-Benz Sprinter brings large groups to their destination comfortably and together. With room for up to 19 guests and ample luggage, it is the ideal solution for events, delegations, corporate outings and larger transfers.' },
    ...
    vben: {
      ...
      items: ['Room for up to 19 guests plus lots of luggage', 'Ideal for events, delegations and corporate outings', 'Experienced chauffeurs, discreet, punctual, with flight monitoring', 'Fixed prices with no hidden costs'],
      badge: { big: '19', sm: 'Seats' },
    },
    vprice: {
      title: 'Transparent fixed prices.',
      sub: 'No hidden costs — waiting time, tolls and parking fees are always included. Guaranteed at the time of booking.',
    ...
    faq: [
      ...
      { q: 'How many guests fit in the Mercedes-Benz Sprinter?', a: 'Depending on the configuration, the Sprinter offers room for up to 19 guests plus luggage — ideal for large groups.' },
