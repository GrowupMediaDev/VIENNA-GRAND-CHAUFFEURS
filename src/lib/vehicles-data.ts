...
export const VEHICLES_DATA: Vehicle[] = [
...

  {
    ...
    metaDescription: 'VIP Minibus mit Chauffeur in Wien: komfortabler Kleinbus für Gruppen bis 16 Personen. Ideal für Events und Ausflüge. Jetzt anfragen. Komfortabel und gut',
    heroSub: 'Der komfortable Kleinbus mit Chauffeur. Viel Platz und Komfort für Gruppen bis zu sechzehn Personen in Wien. Alle bleiben komfortabel zusammen.',
    heroStats: [
    ...
    vover: { titleLead: 'Komfort für', titleAccent: 'größere Gruppen', body: 'Wer einen Kleinbus mieten Wien und Umgebung möchte, findet im VIP Minibus die komfortable Lösung. Bis zu sechzehn Passagiere reisen bequem und gemeinsam, mit angenehmen Sitzen und viel Platz für Gepäck. Ideal für Firmenausflüge, Hochzeitsgesellschaften oder Reisegruppen, die zusammenbleiben möchten.' },
    ...
    faq: [
      { q: 'Für wie viele Personen ist der VIP Minibus geeignet?', a: 'Für bis zu sechzehn Passagiere samt Gepäck. Für noch größere Gruppen steht der 20-Sitzer Sprinter bereit.' },
...
export const VEHICLES_DATA_EN: Vehicle[] = [
...

  {
    ...
    metaDescription: 'VIP minibus with chauffeur in Vienna: comfortable minibus for groups up to 16 people. Ideal for events and excursions. Comfortable and well organised.',
    heroSub: 'The comfortable minibus with chauffeur. Plenty of room and comfort for groups of up to sixteen people in Vienna. Everyone stays comfortably together.',
    heroStats: [
    ...
    img: { hero: '/images/fahrzeuge/vip-minibus-hero.webp', ueberblick: '/images/fahrzeuge/ueberblick-vip-minibus.webp', vorteil: '/images/fahrzeuge/vorteil-vip-minibus.jpg', kabineBg: KAB_BG, gallery: ['/images/fahrzeuge/vip-minibus-gal-1.jpg', '/images/fahrzeuge/vip-minibus-gal-2.jpg', '/images/fahrzeuge/vip-minibus-gal-3.jpg', '/images/fahrzeuge/vip-minibus-gal-4.jpg', '/images/fahrzeuge/vip-minibus-gal-5.jpg'], card: '/images/fahrzeuge/card-vip-minibus.webp' },
    vover: { titleLead: 'Comfort for', titleAccent: 'larger groups', body: 'The VIP minibus combines group size with comfort. Up to sixteen passengers travel comfortably and together, with pleasant seats and plenty of room for luggage. Ideal for company outings, wedding parties or travel groups who want to stay together. A vehicle that brings larger groups to the' },
    ...
    faq: [
      { q: 'How many people fit in the VIP minibus?', a: 'Up to sixteen passengers with luggage. For even larger groups the 20-seater Sprinter is ready.' },
