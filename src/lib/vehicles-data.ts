...
export const VEHICLES_DATA: Vehicle[] = [
...

  {
    ...
    vprice: {
      ...
      cards: [
        ...
        { title: 'Stundensatz', sub: 'Mindestens 3 Stunden', price: '€360', unit: '/ Stunde', desc: 'Chauffeur zur freien Verfügung — ideal für Roadshows, Firmenevents und VIP-Programme. Inkl. max. 20 km pro Stunde.', cta: 'Stunden buchen' },
...

  {
    ...
    img: { hero: '/images/fahrzeuge/business-sprinter-gal-1.webp', ueberblick: '/images/fahrzeuge/ueberblick-business-sprinter.webp', vorteil: '/images/fahrzeuge/vorteil-business-sprinter.webp', kabineBg: KAB_BG, gallery: ['/images/fahrzeuge/business-sprinter-gal-1.webp', '/images/fahrzeuge/business-sprinter-gal-2.webp', '/images/fahrzeuge/business-sprinter-gal-5.webp'], card: '/images/fahrzeuge/card-business-sprinter.jpg' },
...

  {
    ...
    vprice: {
      ...
      cards: [
        ...
        { title: 'Hourly rate', sub: 'Minimum 3 hours', price: '€360', unit: '/ hour', desc: 'Chauffeur at your disposal — ideal for roadshows, corporate events and VIP programmes. Incl. max. 20 km per hour.', cta: 'Book by the hour' },
